...
<body style="font-family: 'Ropa Sans', sans-serif; background-image: url('Asset/background_container.jpg'); background-size: cover; background-repeat: no-repeat; background-attachment: fixed;">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php"><img src="Asset/pom_icon.png" alt="logo" style="width: 60px;"></a>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="fs-6 dropdown-item active" href="index.php">List</a></li>
    ...
    <div class="card text-center mx-auto mb-3" style="width: 95%; background-color: rgba(0, 0, 0, 0); border: 1px solid rgba(0, 0, 0, 0);">
        ...
        <h1 class="text-center text-light">Character List</h1>
        <br>
        ...
        <div class="card-body">
            <table class="table">
                ...
                <tbody class="table-group-divider">
                    ...
                    ?>
                        <tr>
                            <th scope="row"><p class="col mt-3"><?= ($count); ?></p></th>
                            <td class="row text-center">
                                <img style="width: 75px;" src="<?= "Asset/" . $chara->name . ".webp" ?>" alt="Category Image">
                                <p class="col mt-3"><?= $chara->name ?></p>
                            </td>
                            <td><p class="col mt-3"><?= $chara->path ?></p></td>
                            <td><p class="col mt-3"><?= $chara->element ?></p></td>
                            <td><p class="col mt-3"><?= $chara->rarity ?></p></td>
                            <td><p class="col mt-3"><?= $chara->region ?></p></td>
                            <td><p class="col mt-3"><?= $chara->hp ?></p></td>
                            <td><p class="col mt-3"><?= $chara->attack ?></p></td>
                            <td><p class="col mt-3"><?= $chara->def ?></p></td>
                            <td><p class="col mt-3"><?= $chara->spd ?></p></td>
                            <th>
                                <a href="update_HSR.php?update_ID=<?= $index ?>" class="text-decoration-none">
                                    <button class="btn btn-warning mt-2">Update</button>
                                </a>
                                <a href="controller_HSR.php?delete_chara_ID=<?= $index ?>" class="text-decoration-none">
