...
if (isset($_GET["update_ID"])) {
    $chara_ID = $_GET["update_ID"];
    $chara = getCharabyID($_GET["update_ID"]);
}
?>
...
<body style="font-family: 'Ropa Sans', sans-serif; background-image: url('Asset/background_container.jpg'); background-size: cover; background-repeat: no-repeat; background-attachment: fixed;">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php"><img src="Asset/question_icon.png" alt="logo" style="width: 60px;"></a>
    ...
    <div class="card text-center mx-auto mb-5" style="width: 95%; background-color: rgba(0, 0, 0, 0); border: 1px solid rgba(0, 0, 0, 0);">
        ...
        <h1 class="text-center text-light">Update Your Unit!</h1>
        <br>
        ...
        <div class="card-header mx-2">
            <ul class="nav nav-pills card-header-pills">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active" href="#">Update</a>
                </li>
            </ul>
        </div>
        <form method="POST" action="controller_HSR.php" class="w-75 mx-auto">
            ...
            <div class="pb-5 row g-3 text-light">
                <div class="col-md-3">
                    <label for="input_hp" class="form-label text-white">HP</label>
                    <input type="number" class="form-control" name="input_hp" value="<?= $chara->hp ?>">
                </div>
                <div class="col-md-3">
                    <label for="input_attack" class="form-label text-white">Attack</label>
                    <input type="number" class="form-control" name="input_attack" value="<?= $chara->attack ?>">
                </div>
                <div class="col-md-3">
                    <label for="input_defense" class="form-label text-white">Defense</label>
                    <input type="number" class="form-control" name="input_defense" value="<?= $chara->def ?>">
                </div>
                <div class="col-md-3">
                    <label for="input_spd" class="form-label text-white">SPD</label>
                    <input type="number" class="form-control" name="input_spd" value="<?= $chara->spd ?>">
                </div>
            </div>

            <input type="hidden" name="update_ID" value="<?= $chara_ID ?>">
            <div class="col-md-12">
                <button name="button_update_chara" type="submit" class="btn btn-lg btn-primary">Update</button>
            </div>
