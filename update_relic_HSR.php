...
if (isset($_GET["update_ID"])) {
    $relic_ID = $_GET["update_ID"];
    $relic = getRelicbyID($_GET["update_ID"]);
}
?>
<!doctype html>
<html lang="en">
...
<body style="font-family: 'Ropa Sans', sans-serif; background-image: url('Asset/background_container.jpg'); background-size: cover; background-repeat: no-repeat; background-attachment: fixed;">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php"><img src="Asset/kafka_icon.png" alt="logo" style="width: 60px;"></a>
    ...
    <div class="card text-center mx-auto mb-5" style="width: 95%; background-color: rgba(0, 0, 0, 0); border: 1px solid rgba(0, 0, 0, 0);">
        ...
        <h1 class="text-center text-light">Update Your Relic!</h1>
        <br>
        ...
        <form method="POST" action="controller_HSR.php" class="w-75 mx-auto">
            <div class="p-5 row g-3 text-light">
                ...
                <div class="col-md-3">
                    ...
                    <select name="input_sub1" class="form-select">
                        <?php if ($relic->substat[0] != null) { ?>
                            <option selected><?= $relic->substat[0] ?></option>
                        <?php } else { ?>
                            <option selected>Choose...</option>
                            <?php }
                ...
                <div class="col-md-3">
                    ...
                    <select name="input_sub2" class="form-select">
                        <?php if ($relic->substat[1] != null) { ?>
                            <option selected><?= $relic->substat[1] ?></option>
                        <?php } else { ?>
                            <option selected>Choose...</option>
                            <?php }
                ...
                <div class="col-md-3">
                    ...
                    <select name="input_sub3" class="form-select">
                        <?php if ($relic->substat[2] != null) { ?>
                            <option selected><?= $relic->substat[2] ?></option>
                        <?php } else { ?>
                            <option selected>Choose...</option>
                            <?php }
                ...
                <div class="col-md-3">
                    ...
                    <select name="input_sub4" class="form-select">
                        <?php if ($relic->substat[3] != null) { ?>
                            <option selected><?= $relic->substat[3] ?></option>
                        <?php } else { ?>
                            <option selected>Choose...</option>
                            <?php }
            ...
            <input type="hidden" name="update_ID" value="<?= $relic_ID ?>">                       
            <div class="col-md-12">
                <button name="button_update_relic" type="submit" class="btn btn-lg btn-primary">Update</button>
            </div>
